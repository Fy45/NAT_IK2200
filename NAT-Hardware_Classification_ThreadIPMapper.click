...
StaticThreadSched(nicIn1 2);


// Module's I/O
nicIn0  :: FromDPDKDevice($iface0, BURST $burst, SCALE parallel,  N_QUEUES 2, VERBOSE 99, PROMISC true);
nicOut0 :: ToDPDKDevice  ($iface0, IQUEUE $queueSize, BURST $burst);

nicIn1  :: FromDPDKDevice($iface1, BURST $burst, VERBOSE 99, PROMISC true);

...
class STLS1(object):
    ...
    def _create_stream (self):
        ...
        base_pkt0 = Ether() / IP(src = "192.168.100.157", dst = "192.168.200.175") / UDP(dport = self.dport, sport = self.sport)  
        ...
        streams = []
        streams.append(STLStream(packet = pkt0, mode = STLTXCont(pps=self.pps), flow_stats = STLFlowLatencyStats(pg_id = self.pg_id)))
        return streams

...
class_left[0] -> CPUSwitch -> ARPResponder(left_interface) -> nicOut0;
class_left[1] -> CPUSwitch -> [1]arpq_left;
class_left[2] -> Strip(14)-> CheckIPHeader -> class_port_l;
class_port_l[0] -> my_pipeliner_l_0 -> Cpuleft[0] -> Print(CPU0) -> ip_rw_l_0;
class_port_l[1] -> my_pipeliner_l_1 -> Cpuleft[1] -> Print(CPU1) -> ip_rw_l_1;
...
class_right[0] -> CPUSwitch -> ARPResponder(right_interface) -> nicOut1;
class_right[1] -> CPUSwitch -> [1]arpq_right;

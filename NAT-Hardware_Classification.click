...
StaticThreadSched(my_pipeliner_0 0, my_pipeliner_1 1, nicIn1 2);

// Module's I/O
nicIn0  :: FromDPDKDevice($iface0, BURST $burst, N_QUEUES 2, PROMISC true, VERBOSE 99, SCALE parallel);
